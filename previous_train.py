    ...
    for epoch in range(num_epochs):
        ...
        for phase in ['train']:
            ...
            for data in dataloaders:
                ...
                writer.add_scalars(f'batch_loss',
                                   {'voxel_loss': voxel_recons_loss.item(), 'image_loss': img_recons_loss,
                                    'reid_loss': loss_reid}, batch_count)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--AN_loss', default='SSIM', type=str,
                        help='choice of structural and image reconstruction loss for'
